/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/auth-worker/wrangler.jsonc cloudflare/auth-worker/worker-configuration.d.ts` (hash: e03a068c4520b699a6f46a08f9c61d02)
