/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/auth-worker/wrangler.jsonc cloudflare/auth-worker/worker-configuration.d.ts` (hash: eda627b96eed1215e497fb707a77ace9)
...
interface __BaseEnv_Env {
	...
	REMOTE_SESSIONS: DurableObjectNamespace<import("./src/index").RemoteSession>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RemoteSession";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "SESSION_TTL_SECONDS" | "ALLOW_REGISTRATION">> {}
}
